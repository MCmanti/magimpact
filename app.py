...
def main():
    ...
    if wearpart_type == "Impeller":
        ...
        inputs = [
            wearpart_type, "Averge wear part lifetime", tip_speed, table_diameter, flow_rate, abrasivity, density,
        ...
        inputs = [
            wearpart_type, "Averge wear part lifetime", tip_speed, num_impellers, flow_rate, abrasivity, density,
